 ...
 * 安装eventTime划分窗口
 */
public class EventNonKeyedWindowNewApi {
    public static void main(String[] args) throws Exception {
        ...
        streamSource.assignTimestampsAndWatermarks(WatermarkStrategy.<String>forBoundedOutOfOrderness(Duration.ofSeconds(2)).withTimestampAssigner(new SerializableTimestampAssigner<String>() {
                    @Override
